...
export interface IClient {
     ...
     * @return Success
     */
    getCategoryProduct(idcategory?: number | undefined): Observable<Product[]>;
    /**
     * @return Success
     */
     ...
     * @return Success
     */
    logInUser(userName?: string | undefined, password?: string | undefined): Observable<void>;
    /**
     * @return Success
     */
...
export class Client implements IClient {
     ...
     */
    getCategoryProduct(idcategory?: number | undefined): Observable<Product[]> {
        let url_ = this.baseUrl + "/api/v1/Products/getCategoryProduct?";
        if (idcategory === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCategoryProduct(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<Product[]>;
                }
            } else
    ...
    protected processGetCategoryProduct(response: HttpResponseBase): Observable<Product[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    logInUser(userName?: string | undefined, password?: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/v1/Users/LogInUser?";
        if (userName === null)
